...
void (function updateModules() {
  ...
  //console.log('store.modules before resolveStoreModules: ', store.modules);
  ...
  //console.log('store.modules after resolveStoreModules: ', store.modules);
...
function resolveStoreModules(moduleData, filename) {
  ...
  // console.log('resolveStoreModules namespaces: ', namespaces);
  let moduleName = namespaces[namespaces.length - 1];
  const filePath = `store/${filename}`;
  // console.log('resolveStoreModules, filePath: ', filePath);
  moduleData =
    moduleName === 'state'
  ...
  if (VUEX_PROPERTIES.includes(moduleName)) {
    ...
    // console.log('VUEX_PROPERTIES.includes storeModule: ', storeModule);
